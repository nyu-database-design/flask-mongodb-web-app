...
app.connection = pymongo.MongoClient(app.config['MONGO_HOST'], 27017, 
                                username=app.config['MONGO_USER'],
                                password=app.config['MONGO_PASSWORD'],
                                authSource=app.config['MONGO_DBNAME'])
...
def read():
    ...
    """
    collection = app.connection[app.config['MONGO_DBNAME']]["exampleapp"] # get the collection
